...
public class StudentPageActivity extends AppCompatActivity {
    ...
    private Spinner branchNameSpinner, yearSpinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        branchNameSpinner = findViewById(R.id.branchNameSpinner);
        ...
        branchNameSpinner.setAdapter(branchAdapter);
    ...
    private void registerStudent() {
        ...
        String branchName = branchNameSpinner.getSelectedItem().toString();
        ...
        if (branchNameSpinner.equals("Select")) {
            Toast.makeText(this, "Please select a department", Toast.LENGTH_SHORT).show();
            return;
        }

        if (yearSpinner.equals(("select"))) {
    ...
    private void clearInputs() {
        ...
        branchNameSpinner.setSelection(0); // Reset to first item in department spinner
        yearSpinner.setSelection(0);   // Reset to first item in semester spinner
